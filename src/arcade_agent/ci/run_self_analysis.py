...
Usage:
    arcade-self-analysis [--output-json results.json] [--output-html report.html]
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Apply arcade-agent self-dogfooding filters for private helpers and "
            "registration decorators. Leave disabled for generic repositories."
        ),
    )
