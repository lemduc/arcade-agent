...
arcade-agent is a framework-agnostic tool library for software architecture analysis. It provides composable tools for parsing source code, recovering architecture, detecting smells, computing metrics, and comparing versions. Tools work standalone or plug into MCP/LangChain/Codex SDK.
